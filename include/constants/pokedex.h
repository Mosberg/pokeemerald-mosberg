...
enum NationalDexOrder
{
    ...
    NATIONAL_DEX_ASTRALIT,
    NATIONAL_DEX_ASTRALIT_AURORA,
    NATIONAL_DEX_ASTRALIT_TIDE,
    NATIONAL_DEX_ASTRALIT_STORM,
    NATIONAL_DEX_ASTRALIT_FINAL,
    NATIONAL_DEX_FERROVALE,
    NATIONAL_DEX_FERROVALE_CINDER,
    NATIONAL_DEX_FERROVALE_MARROW,
    NATIONAL_DEX_FERROVALE_TITAN,
    NATIONAL_DEX_FERROVALE_FINAL,
    NATIONAL_DEX_NIMBARA,
    NATIONAL_DEX_NIMBARA_LEAF,
    NATIONAL_DEX_NIMBARA_BLOOM,
    NATIONAL_DEX_NIMBARA_GALE,
    NATIONAL_DEX_NIMBARA_FINAL,
};

#define JOHTO_DEX_COUNT     NATIONAL_DEX_CELEBI

#if P_GEN_9_POKEMON == TRUE
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_NIMBARA_FINAL
