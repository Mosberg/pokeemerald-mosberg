...
static const struct LevelUpMove sAstralitLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 1, MOVE_PSYWAVE),
    LEVEL_UP_MOVE( 7, MOVE_CONFUSION),
    LEVEL_UP_MOVE(14, MOVE_ASTRAL_LANCE),
    LEVEL_UP_MOVE(22, MOVE_CALM_MIND),
    LEVEL_UP_MOVE(30, MOVE_PSYCHIC),
    LEVEL_UP_END
};

static const struct LevelUpMove sAstralitAuroraLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 1, MOVE_CONFUSION),
    LEVEL_UP_MOVE( 1, MOVE_PSYWAVE),
    LEVEL_UP_MOVE(12, MOVE_ASTRAL_LANCE),
...
static const struct LevelUpMove sAstralitTideLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 1, MOVE_CONFUSION),
    LEVEL_UP_MOVE( 1, MOVE_ASTRAL_LANCE),
    LEVEL_UP_MOVE(12, MOVE_WATER_PULSE),
    LEVEL_UP_MOVE(22, MOVE_CALM_MIND),
    LEVEL_UP_MOVE(32, MOVE_PSYCHIC),
...
static const struct LevelUpMove sAstralitStormLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 1, MOVE_CONFUSION),
    LEVEL_UP_MOVE( 1, MOVE_ASTRAL_LANCE),
    ...
    LEVEL_UP_MOVE(48, MOVE_COSMIC_SUNDER),
    LEVEL_UP_END
};

static const struct LevelUpMove sAstralitFinalLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 1, MOVE_CONFUSION),
    LEVEL_UP_MOVE( 1, MOVE_ASTRAL_LANCE),
    ...
    LEVEL_UP_MOVE(32, MOVE_PSYCHIC),
    LEVEL_UP_MOVE(44, MOVE_THUNDERBOLT),
    LEVEL_UP_MOVE(56, MOVE_COSMIC_SUNDER),
    LEVEL_UP_MOVE(68, MOVE_DRAGON_CLAW),
    LEVEL_UP_END
};
#endif //P_FAMILY_ASTRALIT

#if P_FAMILY_FERROVALE
static const struct LevelUpMove sFerrovaleLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE( 7, MOVE_METAL_CLAW),
    LEVEL_UP_MOVE(14, MOVE_FERRO_THRUST),
    LEVEL_UP_MOVE(22, MOVE_IRON_DEFENSE),
    LEVEL_UP_MOVE(30, MOVE_ROCK_SLIDE),
    LEVEL_UP_END
};

static const struct LevelUpMove sFerrovaleCinderLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_METAL_CLAW),
    LEVEL_UP_MOVE(12, MOVE_EMBER),
    LEVEL_UP_MOVE(20, MOVE_FERRO_THRUST),
    LEVEL_UP_MOVE(29, MOVE_FIRE_SPIN),
    LEVEL_UP_MOVE(38, MOVE_IRON_HEAD),
    LEVEL_UP_END
};

static const struct LevelUpMove sFerrovaleMarrowLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_METAL_CLAW),
    LEVEL_UP_MOVE(12, MOVE_EARTHQUAKE),
    LEVEL_UP_MOVE(22, MOVE_FERRO_THRUST),
    LEVEL_UP_MOVE(32, MOVE_STONE_EDGE),
    LEVEL_UP_MOVE(44, MOVE_IRON_HEAD),
    LEVEL_UP_END
};

static const struct LevelUpMove sFerrovaleTitanLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_FERRO_THRUST),
...
static const struct LevelUpMove sFerrovaleFinalLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_SAND_ATTACK),
    LEVEL_UP_MOVE( 1, MOVE_FERRO_THRUST),
...
#if P_FAMILY_NIMBARA
static const struct LevelUpMove sNimbaraLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_GROWTH),
    LEVEL_UP_MOVE( 1, MOVE_RAZOR_LEAF),
    LEVEL_UP_MOVE( 7, MOVE_VINE_WHIP),
...
static const struct LevelUpMove sNimbaraLeafLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_GROWTH),
    LEVEL_UP_MOVE( 1, MOVE_RAZOR_LEAF),
    LEVEL_UP_MOVE( 1, MOVE_VINE_WHIP),
    LEVEL_UP_MOVE(12, MOVE_NIMBARA_BLOSSOM),
    LEVEL_UP_MOVE(20, MOVE_MAGICAL_LEAF),
    LEVEL_UP_MOVE(29, MOVE_GIGA_DRAIN),
    LEVEL_UP_END
};

static const struct LevelUpMove sNimbaraBloomLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_GROWTH),
    LEVEL_UP_MOVE( 1, MOVE_RAZOR_LEAF),
    LEVEL_UP_MOVE( 1, MOVE_VINE_WHIP),
    LEVEL_UP_MOVE(12, MOVE_NIMBARA_BLOSSOM),
...
static const struct LevelUpMove sNimbaraGaleLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_GROWTH),
    LEVEL_UP_MOVE( 1, MOVE_RAZOR_LEAF),
    LEVEL_UP_MOVE( 1, MOVE_VINE_WHIP),
    LEVEL_UP_MOVE(14, MOVE_WING_ATTACK),
    LEVEL_UP_MOVE(26, MOVE_NIMBARA_BLOSSOM),
    LEVEL_UP_MOVE(38, MOVE_AIR_SLASH),
    LEVEL_UP_MOVE(52, MOVE_SOLAR_BEAM),
    LEVEL_UP_END
};

static const struct LevelUpMove sNimbaraFinalLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_GROWTH),
    LEVEL_UP_MOVE( 1, MOVE_RAZOR_LEAF),
    LEVEL_UP_MOVE( 1, MOVE_VINE_WHIP),
    LEVEL_UP_MOVE(18, MOVE_NIMBARA_BLOSSOM),
